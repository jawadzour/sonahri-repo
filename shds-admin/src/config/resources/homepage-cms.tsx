...
export const homepageCmsConfig: ResourceConfig<ContentBlock> = {
  key: "homepage-cms",
  label: "Homepage CMS",
  singularLabel: "Section",
  description:
    "Manage editable content sections on the public homepage (hero, highlights, stats, calls to action).",
  ...
  fields: [
    {
      ...
      type: "text",
      required: true,
      placeholder: "hero, mission_stats, cta...",
  ...
  emptyStateTitle: "No homepage sections yet",
};
